export const faqs = [
  ...
  {
    id: 2,
    ques: "Who is eligible to be registered as a general elector?",
    ans: " Every Indian citizen who has attained the age of 18 years on the qualifying date i.e. first day of January of the year of revision of electoral roll, unless otherwise disqualified, is eligible to be registered as a voter ,",
  },
  {
    id: 3,
    ques: "Can a non-citizen of India become a voter in the electoral rolls in India?",
  ...
  {
    id: 4,
    ques: "Is a documentary proof of age required in cases where age of the applicant is more than 21 years?",
  ...
  {
    id: 5,
    ques: "Who is competent to verify claim applications and objections?",
